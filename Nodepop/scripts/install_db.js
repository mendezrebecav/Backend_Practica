...
const conn = require("../servicios_generales/baseDatoMongoDB");
const Anuncio = require("../apiServices/anuncios/mongoose.js");

const file = "./servicios_generales/data/anuncios.json";
